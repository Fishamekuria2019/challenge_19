...
ether_balance = get_balance(w3=w3, address=account.address)
...
# YOUR CODE HERE
# w3.eth.get_generate_account("address")
# w3.eth.get_balance("wallet")
# w3.eth.send_transaction("account, to, wage")
...
# YOUR CODE HERE
# wage = w3.eth.wage({"to": person, "from": account.address, "hourly_rate": hours})
...
if st.sidebar.button("Send Transaction"):
    ...
    # YOUR CODE HERE
    transaction_hash = send_transaction(w3=w3, account=account, wage=total_wage, to=candidate_address)
